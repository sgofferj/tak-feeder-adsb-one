...
module.exports.adsb2cot = (item) => {
  ...
  if (
    ...
    if (cott == "a-f-A-C-H" && operator.includes("#LEO")) {
    ...
    if (cott == "a-f-A-C-F" && operator.includes("#LEO")) {
      packet["event"]["detail"]["__milsym"] = {
        _attributes: {
          id: "SUGP-----------",
        },
    ...
    if (cott == "a-f-A-C-H" && operator.includes("#EMS")) {
      packet["event"]["detail"]["__milsym"] = {
        _attributes: {
          id: "SFAPCH---------",
        },
    ...
    if (cott == "a-f-A-C-H" && operator.includes("#FIRE")) {
      packet["event"]["detail"]["__milsym"] = {
        _attributes: {
          id: "SFAPCH---------",
        },
    ...
    if (cott == "a-f-A-C-F" && operator.includes("#FIRE")) {
      if (actype.includes("CL-415") || actype.includes("DHC-8")) {
        packet["event"]["detail"]["__milsym"] = {
          _attributes: {
            id: "SFAPCF---------",
          },
